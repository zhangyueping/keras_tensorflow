...
class Imdb_MLP(object):
    ...
    def models(self,x_train,y_train):
        ...
        model.add(Embedding(output_dim=32,input_dim=3800,input_length=380)) #(2000,32)embedding已经初始化
        ...
        #训练模型
        try:
            model = load_model('savemodel/cimdbmodel_dict3800.h5')
            print('模型加载成功')
        except:
            ...
            model.save('savemodel/cimdbmodel_dict3800.h5')
